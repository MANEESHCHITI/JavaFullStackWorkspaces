 ...
 *   directed to html page from there servket open by action by condition it evaluates by default it is doget in the browser we see the userename and password
